...
document.addEventListener("mousemove", (e) => {
  ...
  const randomBinary = Math.floor(Math.random() * 3);
  const colors = [generateColor(81,10,221),generateColor(255,60,95),generateColor(81,10,221)]
  
  pointer.color = colors[randomBinary];
});
...
function generateColor(r=0.89,g=1.0,b=1.0) {
  // console.log("Math.random():", Math.random());
  // let c = HSVtoRGB(r, g, b);
  let c={r:r/255,g:g/255,b:b/255}
  c.r *= 0.5;
  c.g *= 0.5;
  c.b *= 0.5;
  return c;
